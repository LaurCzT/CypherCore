...
namespace Game.Networking.Adapters.V1_14_0
{
    ...
    public static class CharacterCustomizations
    {
        ...
        public static void ConvertModernCustomizationsToLegacy(List<ChrCustomizationChoice> customizations, out byte skin, out byte face, out byte hairStyle, out byte hairColor, out byte facialHair)
        {
            ...
            {
                LegacyCustomizationOption option = GetLegacyCustomizationOption((uint)custom.ChrCustomizationOptionID);
                byte choice = GetLegacyCustomizationChoice((uint)custom.ChrCustomizationChoiceID);
        ...
        public static int GetModernCustomizationOption(Race raceId, Gender gender, LegacyCustomizationOption option)
        {
            switch (raceId)
            {
                case Race.Human:
        ...
        public static int GetModernCustomizationChoice(Race raceId, Gender gender, LegacyCustomizationOption option, byte value)
        {
            switch (raceId)
            {
                case Race.Human:
            ...
            return 0;
                ...
                public static ChrCustomizationChoice[] ConvertLegacyCustomizationsToModern(Race raceId, Gender gender, byte skin, byte face, byte hairStyle, byte hairColor, byte facialHair)
        {
            var customizations = new ChrCustomizationChoice[5];
            customizations[0] = new ChrCustomizationChoice { ChrCustomizationOptionID = GetModernCustomizationOption(raceId, gender, LegacyCustomizationOption.Skin), ChrCustomizationChoiceID = GetModernCustomizationChoice(raceId, gender, LegacyCustomizationOption.Skin, skin) };
            customizations[1] = new ChrCustomizationChoice { ChrCustomizationOptionID = GetModernCustomizationOption(raceId, gender, LegacyCustomizationOption.Face), ChrCustomizationChoiceID = GetModernCustomizationChoice(raceId, gender, LegacyCustomizationOption.Face, face) };
            customizations[2] = new ChrCustomizationChoice { ChrCustomizationOptionID = GetModernCustomizationOption(raceId, gender, LegacyCustomizationOption.HairStyle), ChrCustomizationChoiceID = GetModernCustomizationChoice(raceId, gender, LegacyCustomizationOption.HairStyle, hairStyle) };
            customizations[3] = new ChrCustomizationChoice { ChrCustomizationOptionID = GetModernCustomizationOption(raceId, gender, LegacyCustomizationOption.HairColor), ChrCustomizationChoiceID = GetModernCustomizationChoice(raceId, gender, LegacyCustomizationOption.HairColor, hairColor) };
            customizations[4] = new ChrCustomizationChoice { ChrCustomizationOptionID = GetModernCustomizationOption(raceId, gender, LegacyCustomizationOption.FacialHair), ChrCustomizationChoiceID = GetModernCustomizationChoice(raceId, gender, LegacyCustomizationOption.FacialHair, facialHair) };

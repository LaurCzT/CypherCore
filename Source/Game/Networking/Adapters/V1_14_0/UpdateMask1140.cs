...
{
    public class UpdateMask1140
    {
        public UpdateMask1140(uint valuesCount = 0)
        {
    ...
    public class DynamicUpdateMask : UpdateMask1140
    {
        public DynamicUpdateMask(uint valuesCount) : base(valuesCount) { }

        public void EncodeDynamicFieldChangeType(DynamicFieldChangeType changeType, Framework.Constants.UpdateType updateType)
        {
            DynamicFieldChangeType = (uint)(_blockCount | ((uint)(changeType & Game.Networking.Adapters.V1_14_0.DynamicFieldChangeType.ValueAndSizeChanged) * ((3 - (int)updateType /*this part evaluates to 0 if update type is not VALUES*/) / 3)));
        }

...
namespace Game.Entities
{
    ...
    public class GameObjectTypeBase
    {
        ...
        public virtual void ActivateObject(GameObjectActions action, int param, WorldObject spellCaster = null, int spellId = 0, int effectIndex = -1) { }
    ...
    class ControlZone : GameObjectTypeBase
    {
        ...
        public override void ActivateObject(GameObjectActions action, int param, WorldObject spellCaster, int spellId, int effectIndex)
        {
            switch (action)
            {
                case GameObjectActions.MakeInert:
        ...
        float CalculatePointsPerSecond(List<Unit> targetList)
        {
            ...
            int minSuperiority = _owner.GetGoInfo().ControlZone.minSuperiority;
            int maxSuperiority = _owner.GetGoInfo().ControlZone.maxSuperiority;
        ...
        void HandleUnitEnterExit(List<Unit> newTargetList)
        {
            ...
            foreach (Player player in enteringPlayers)
            {
                ...
                player.SendUpdateWorldState(_owner.GetGoInfo().ControlZone.worldstate2, (int)_value);
    ...
    public class SetControlZoneValue : GameObjectTypeBase.CustomCommand
    {
        ...
        public SetControlZoneValue(int? value = null)
        {
            _value = value;
        }
        ...
        public override void Execute(GameObjectTypeBase type)
        {
            ...
            if (controlZone != null)
            {
                int value = controlZone.GetStartingValue();
                if (_value.HasValue)
                    value = _value.Value;

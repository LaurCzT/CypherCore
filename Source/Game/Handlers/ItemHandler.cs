...
using Game.Networking.Adapters.V1_14_0;
...
namespace Game
{
    public partial class WorldSession
    {
        ...
        void HandleSplitItem(SplitItem splitItem)
        {
            ...
            ItemPos src = InventorySlots1140.ToItemPos(splitItem.FromSlot, splitItem.FromPackSlot);
            ItemPos dst = InventorySlots1140.ToItemPos(splitItem.ToSlot, splitItem.ToPackSlot);
        ...
        void HandleSwapInvenotryItem(SwapInvItem swapInvItem)
        {
            ...
            ItemPos src = InventorySlots1140.ToInternal(swapInvItem.SourceSlot);
            ItemPos dst = InventorySlots1140.ToInternal(swapInvItem.DestinationSlot);
        ...
        {
            ItemPos dstPos = InventorySlots1140.ToInternal(packet.ItemDstSlot);
            // Inv.Items entries are already ItemPos values (and already translated
            // in InvUpdate) -- rebuilding one from .Container/.Slot swapped the two.
            ItemPos srcPos = packet.Inv.Items[0];
        ...
        void HandleSwapItem(SwapItem swapItem)
        {
            ...
            ItemPos src = InventorySlots1140.ToItemPos(swapItem.SlotA, swapItem.ContainerSlotA);
            ItemPos dst = InventorySlots1140.ToItemPos(swapItem.SlotB, swapItem.ContainerSlotB);
        ...
        void HandleAutoEquipItem(AutoEquipItem autoEquipItem)
        {
            ...
            var player = GetPlayer();
            // 1.14 numbers the backpack from 23; the core numbers it from 35.
            var src = InventorySlots1140.ToItemPos(autoEquipItem.Slot, autoEquipItem.PackSlot);
        ...
        {
            ItemPos itemPos = InventorySlots1140.ToItemPos(destroyItem.SlotNum, destroyItem.ContainerId);
        ...
        {
            ItemPos itemPos = InventorySlots1140.ToItemPos(readItem.Slot, readItem.PackSlot);
        ...
        void HandleAutoStoreBagItem(AutoStoreBagItem packet)
        {
            ...
            ItemPos src = InventorySlots1140.ToItemPos(packet.SlotA, packet.ContainerSlotA);
            ItemPos destBagSlot = new(ItemSlot.Null, InventorySlots1140.ToInternal(packet.ContainerSlotB));
